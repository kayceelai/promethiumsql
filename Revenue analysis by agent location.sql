...
LEFT OUTER JOIN "oracle"."RDSORACLEFORPRESTO"."DIM_AGENT" ON ("oracle"."RDSORACLEFORPRESTO"."FACT_SUBSCRIPTION_ACTIVITY"."AGN_KEY" = "oracle"."RDSORACLEFORPRESTO"."DIM_AGENT"."AGENT_RECORD_KEY")
LIMIT 10000