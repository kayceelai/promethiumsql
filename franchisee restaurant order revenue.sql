...
FROM
  ( SELECT "oracle"."RDSORACLEFORPRESTO"."TLOG_PRODUCT_PLUNAMES"."NAME" AS "Menu Item",
           "oracle"."RDSORACLEFORPRESTO"."TLOG_PRODUCT_PLUNAMES"."AMOUNT" AS "AMOUNT",
   ...
   FROM "oracle"."RDSORACLEFORPRESTO"."TLOG_PRODUCT_PLUNAMES"
   LEFT OUTER JOIN "mysql"."promethium"."restaurant_orders" ON ( "oracle"."RDSORACLEFORPRESTO"."TLOG_PRODUCT_PLUNAMES"."REST_KEY" = "mysql"."promethium"."restaurant_orders"."rest_key" ) )
GROUP BY "Menu Item",
         "city",
         "State",
         "Franchisee Group",
