SELECT
  ("PACKAGE") AS "PACKAGE",
  ("REASON") AS "REASON",
  ("REASON TYPE") AS "REASON TYPE",
  ("REASON GROUP") AS "REASON GROUP",
...
FROM
  (
    SELECT
      ...
      "oracle"."RDSORACLEFORPRESTO"."DIM_REASONCODE"."REASONCODETYPE" AS "REASON TYPE",
      "oracle"."RDSORACLEFORPRESTO"."DIM_REASONCODE"."REASONCODE" AS "REASONCODE",
      "oracle"."RDSORACLEFORPRESTO"."DIM_REASONCODE"."REASONNAME" AS "REASON",
      ...
      "oracle"."RDSORACLEFORPRESTO"."DIM_REASONCODE"."REASONNAMEROLLUP" AS "REASON GROUP",
...
GROUP BY
  "REASON TYPE","REASON","REASON GROUP","PACKAGE"
LIMIT
  1000